...
FROZEN_FOUR_C = ROOT / "reports" / "milestone_4c_regional_conditioning.md"
...
EXPECTED_FOUR_C = "7b40a169c0d8b691d61f5480a6069a270c317be7a2c34671c595a0236fdae392"
...
def test_milestone_four_c_report_is_hashed() -> None:
    assert hashlib.sha256(FROZEN_FOUR_C.read_bytes()).hexdigest() == EXPECTED_FOUR_C
